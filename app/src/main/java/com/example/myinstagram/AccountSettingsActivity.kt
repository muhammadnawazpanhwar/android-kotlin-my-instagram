    ...
    private fun uploadImageAndUpdateInfo() {
        ...
        when {
            ...
            imageUri == null -> Toast.makeText(
                this,
                "Please select the Image first.", Toast.LENGTH_LONG
            ).show()
            ...
            profile_fragment_username.text.toString() == "" -> {
                Toast.makeText(
                    this,
            ...
            bio_profile.text.toString() == "" -> {
                Toast.makeText(
                    this,
                    "Please write your Bio first.", Toast.LENGTH_LONG
                ).show()
            }
            else -> {
                val progressDialog = ProgressDialog(this)
                progressDialog.setTitle("Accoount Settings")
                ...
                uploadTask.continueWithTask(Continuation<UploadTask.TaskSnapshot, Task<Uri>> { task ->
                    ...
                    if(task.isSuccessful){
                        ...
                        Toast.makeText(this, "Your account has been updated successfully.", Toast.LENGTH_LONG).show()
