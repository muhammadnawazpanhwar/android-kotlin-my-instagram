...
class PostAdapter(private val mContext : Context, private val mPost : List<Post>) :
    ...
    private fun publisherInfo(profileImage: CircleImageView, userName: TextView, publisher: TextView, publiherId: String)
    {
        val userRef = FirebaseDatabase.getInstance().reference.child("Users").child(publiherId)
